...
function createLivesHref({
    ...
    return createPathWithQuery("/editor/lives", {
        month,
    ...
    return (
        <main className="space-y-10">
            ...
            <PageHero
                badge="Editor / Lives"
                title="ライブ管理"
                description="今後の予定と過去履歴を公開画面と同じ温度感で保ちます。"
                action={
                    <Link href="/editor/lives/new" className="w-fit rounded-md bg-violet-500 px-5 py-3 text-sm font-black text-white hover:bg-violet-400">
                        新規追加
                    </Link>
                }
            />
                        ...
                        >
                            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                ...
                                <div className="flex gap-2">
                                    <Link
                                        href={`/editor/lives/${live.id}/edit`}
            ...
            <section className="space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 text-sm text-zinc-400">
                    ...
                    {selectedMonth && (
                        <Link href="/editor/lives" className="rounded-sm bg-zinc-900 px-3 py-1.5 text-zinc-100 ring-1 ring-white/10 hover:bg-white hover:text-black">
                            月選択を解除
                        </Link>
                    )}
                </div>
